    ...
    <div className="dashboard-page">
      ...
      <div className="glass-card hotspot-section">
        <div className="card-header">
          ...
          <button className="hotspot-btn" onClick={onLoadHotspots} disabled={loadingHotspots}>
            <TrendingUp size={18} />
            {loadingHotspots ? "Analyzing..." : "Generate Top 10 Hotspots"}
          </button>
        </div>
        ...
        {hotspots.length === 0 && !loadingHotspots && (
          <div className="empty-state-small">
            <p>Click "Generate Top 10 Hotspots" to see the highest-risk locations for the selected period</p>
          </div>
        )}
